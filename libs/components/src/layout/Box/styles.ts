...
export const box = (props: Omit<BoxProps, 'children'>) => css`
    ...
    ${props.mx &&
    `margin-right: calc(${props.mx} * 0.25rem); margin-left: calc(${props.mx} * 0.25rem)`};
    ${props.my &&
    `margin-top: calc(${props.my} * 0.25rem); margin-bottom: calc(${props.my} * 0.25rem)`};
    ...
    ${props.px &&
    `padding-right: calc(${props.px} * 0.25rem); padding-left: calc(${props.px} * 0.25rem)`};
    ${props.py &&
    `padding-top: calc(${props.py} * 0.25rem); padding-bottom: calc(${props.py} * 0.25rem)`};
